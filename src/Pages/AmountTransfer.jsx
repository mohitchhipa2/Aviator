...
const AmountTransfer = () => {
  ...
  return (
    <div style={{display:"flex",justifyContent:'center',fontFamily:'cursive'}} className="active" id="via-email">
    <form
      className="register-form row "
      style={{ margin: "100px auto 0 auto", color: "white !important",marginBottom:"20px"}}
      onSubmit={handleTransfer}
    >
      <h2 style={{color:"white",display:"flex",justifyContent:"center",marginBottom:"20px"}}>Title</h2>
      <div>
